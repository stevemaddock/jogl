...
public class V04_GLEventListener implements GLEventListener {
  ...
  // ***************************************************
  /* interaction
   * Add methods to handle any interaction
   */
   ...
   public void setCamera(int i) {
     ...
     System.out.println("Setting camera to "+i);
     cameraNumber = i;
   }
  ...
  public void initialise(GL3 gl) {
    shader = new Shader(gl, "assets/shaders/vs_V01.txt", "assets/shaders/fs_V01.txt");
    fillBuffers(gl);
    textures = new TextureLibrary();
    textures.add(gl, "cube", "assets/textures/cube.jpg");
    createRandomNumbers();
  }
  ...
  public void render(GL3 gl) {
    ...
    Mat4 viewMatrix = getViewMatrix1();
    if (cameraNumber == 2)
