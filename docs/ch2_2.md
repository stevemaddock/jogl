...
If you have followed the instructions in [Appendix A](appendixA.md) you should have installed JOGL correctly. If so, you can now run the program to display a triangle using the following (where prompt may indicate which folder you are in, e.g. C:\COM3503):
