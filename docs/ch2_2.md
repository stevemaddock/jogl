...
<details>
  <summary>What OpenGL primitive rendering mode would you typically use to draw a series of connected line segments using JOGL?</summary>
  <p>
    a) <code>GL.GL_TRIANGLES</code>
    <br>
    b) <code>GL.GL_LINES</code>
    <br>
    c) <code>GL.GL_LINE_STRIP</code>
    <br>
    d) <code>GL.GL_POINTS</code>
  </p>
</details>
<details>
  <summary>Answer</summary>
  <p><b>c) <code>GL.GL_LINE_STRIP</code></b></p>
  <p><code>GL_LINE_STRIP</code> draws connected line segments. It uses the end of the previous segment as the start of the next, requiring one fewer vertex than individual lines for a connected strip.</p>
</details>
