...
Program Listings 2.x and 2.y give the vertex and fragment shaders, respectively. These are hard-coded as Strings in Program Listing 2.8. In later programs, we'll load them from text files.
