...
1. Change the colour of the triangle that is drawn. (Hint: change the fragment shader - Program Listing 2.8.) Examples in future chapters will show how this can be done from the application rather that by hard-coding it into the fragment shader. [Solution]
