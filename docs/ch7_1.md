...
1. Experiment with changing the material properties of the light. What impact does this have on the final rendering? (It can be difficult to predict the results when different coloured lights are mixed.) (This exercise is similar to the one in Section 6.2, but now using a class.)
