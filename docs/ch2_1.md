...
If you have followed the instructions in [Appendix A](appendixA.md) you should have installed JOGL correctly. If so, you can now run the first program to display a blank screen using the following:

`C:\com3503>javac A01.java`

`C:\com3503>java A01`

Sections 2.2 and 2.3 are more interesting!!
