...
2. Add a uniform variable that varies the amount of mix over time. [Solution](#exercise-solutions)
3. Add a third texture and use multiple calls of mix to blend the three textures. [Solution](#exercise-solutions)
...
<details>
<summary>b) gl.glActiveTexture() selects a specific texture unit to work with, while textureId1.bind(gl) links a specific texture object to that active texture unit.</summary>
...
<details>
<summary>c) gl.glActiveTexture() is used in the fragment shader, while textureId1.bind(gl) is used in the main Java application.</summary>
...
<details>
<summary>d) gl.glActiveTexture() prepares the texture data, while textureId1.bind(gl) passes the data to the uniform.</summary>
...
<details>
<summary>a) It blends the two textures, taking 70% of first_texture and 30% of second_texture.</summary>
...
<details>
<summary>b) It mixes the first_texture with the fragment's interpolated color, taking 30% of each.</summary>
...
<details>
<summary>c) It blends the two textures, taking 30% of first_texture and 70% of second_texture.</summary>
...
<details>
<summary>d) It interpolates the colors of the two textures across the surface of the triangle.</summary>
...
A uniform, mixAmount, is added to the fragment shader:
...
The render method then varies the mixAmount using the Math.sin function and the system time:
...
3. Add a third texture and use multiple calls of mix to blend the three textures.

Here, the variable mixAmount is used twice in the fragment shader fs_T02e3.txt:
...
The initialise and render methods also need to be updated to supply a third texture.
