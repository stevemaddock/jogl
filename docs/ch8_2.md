...
2. Add another sphere on top of the upper sphere. Using variables instead of literals in the initialise method will make this easier. Figure 8.x (TO BE COMPLETED) shows a possible solution. [Solution](#exercise-solutions)
...
2. Add another sphere on top of the upper sphere. Using variables instead of literals in the initialise method will make this easier. Figure 8.x (TO BE COMPLETED) shows a possible solution.
