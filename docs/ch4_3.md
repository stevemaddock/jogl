...
<p align="center">
  <img src="ch4_img/ch4_3_dynamic_textures.jpg" alt="A  triangle" width="200"><br>
  <strong>Figure 4.6:</strong> Output from T04.java.
</p>

<p align="center">
  <img src="ch4_img/ch4_3_moving_clouds.gif" alt="A  triangle" width="200"><br>
...
1. Change the calculation of offset in method render() to see what dynamic effect you can create. (Don't forget to change the settings in the loadTexture method in TextureLibrary.java, as described above.) [Solution]
...
<p align="center">
  <img src="ch4_img/ch4_3_changing_textures.gif" alt="A  triangle" width="200"><br>
