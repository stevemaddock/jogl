...
<details>
<summary>d) The light a surface emits on its own, regardless of any external light sources.</summary>
...
<details>
<summary>c) By taking the dot product of the view vector and the reflected light vector, and raising the result to a power that represents the surface's shininess.</summary>
