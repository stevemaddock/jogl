...
/**
 * This class handles OpenGL events for the A02 application.
 *
...
public class A02_GLEventListener implements GLEventListener {
  ...
  public void dispose(GLAutoDrawable drawable) {
    ...
    gl.glDeleteBuffers(1, vertexBufferId, 0);
                                    // Clean up memory.
                                    // This is not strictly necessary in this example, as the program exits
                                    // immediately after the window is closed, but it is good practice.
                                    // We can leave out the calls to clean up memory in later examples, since
                                    // the program will exit immediately after the window is closed.
  }
  ...
  private void fillBuffers(GL3 gl) { 
                                    // This the method where data is passed to the GPU.
  ...
  private String vertexShaderSource = 
    ...
    "\n" +                          // We choose position as the the name 
                                    // for transferring (x,y,z) position data to the vertex shader
    "layout (location = 0) in vec3 position;\n" +
    "\n" +
    "void main(){\n" +              // gl_Position is the default name the GPU pipeline expects
