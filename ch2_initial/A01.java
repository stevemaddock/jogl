...
public class A01 extends JFrame {   // A subclass of JFrame.
  ...
  private static final Dimension dimension = new Dimension(WIDTH, HEIGHT);
                                    ...
                                    // which is static.
                                    // Also declared as final so it cannot be changed.
  ...
  private A01_GLEventListener glEventListener;
                                    ...
                                    // Below, we see that this is an instance of A01_GLEventListener.
                                    // Currently, the superclass is used as the variable type.
                                    // In later examples, the variable type will be changed to A01_GLEventListener,
                                    // so that the specific methods in A01_GLEventListener can be called directly.
