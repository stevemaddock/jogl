...
public class Scene3 extends JFrame {
  ...
  private Scene3_GLEventListener glEventListener;
  private final FPSAnimator animator; 

  public static void main(String[] args) {
    Scene3 b1 = new Scene3("Scene3");
