...
public class Scene5_GLEventListener implements GLEventListener {
  ...
  public Scene5_GLEventListener(Camera camera) {
    this.camera = camera;
  ...
  public void initialise(GL3 gl) {
    ...
    cube[0] = makeCube(gl, Mat4.multiply(Mat4Transform.translate(0,4,0), Mat4Transform.scale(4,4,4)),
                       "assets/shaders/fs_standard_dse.txt", textures.get("diffuse_container"), textures.get("specular_container"), textures.get("matrix"));
