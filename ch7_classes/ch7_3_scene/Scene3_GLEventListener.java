...
public class Scene3_GLEventListener implements GLEventListener {
  ...
  public void initialise(GL3 gl) {
    ...
    plane = new Model[3];
    plane[0] = makePlane(gl, getM1(), "assets/shaders/fs_standard_0t.txt", null, null, null);
    plane[1] = makePlane(gl, getM2(), "assets/shaders/fs_standard_0t.txt", null, null, null);
