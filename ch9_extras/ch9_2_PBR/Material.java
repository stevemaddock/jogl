...
public class Material implements Cloneable {
  ...
  public Material() {
    this(new Vec3(DEFAULT_AMBIENT), new Vec3(DEFAULT_DIFFUSE), 
         ...
         null, null, null, null,null,null,null,null, DEFAULT_SHININESS);
  }
  ...
  public Material(Vec3 ambient, Vec3 diffuse, Vec3 specular, float shininess) {
    this(ambient, diffuse, specular, new Vec3(DEFAULT_EMISSION), 
         null, null, null, null,null,null,null,null, shininess);
  }
   ...
   * @param  shininess     float value in the range 0.0..1.0.
   */  
   public Material(Texture diffuseMap, Texture specularMap, Texture emissionMap, 
                   Texture albedoMap, Texture normalMap, Texture metallicMap, Texture roughnessMap, 
                   Texture aoMap, float shininess) {
     this(new Vec3(DEFAULT_AMBIENT), new Vec3(DEFAULT_DIFFUSE), 
          new Vec3(DEFAULT_SPECULAR), new Vec3(DEFAULT_EMISSION), 
          diffuseMap, specularMap, emissionMap, albedoMap, normalMap, metallicMap, roughnessMap, aoMap, shininess);
   }
  ...
  */    
  ...
  public Material clone() {
    ...
    cloned.albedoMap = this.albedoMap;
    cloned.normalMap = this.normalMap;
    cloned.metallicMap = this.metallicMap;
