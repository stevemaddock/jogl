...
public class Camera {
  ...
  public void keyboardInput(Movement movement) {
    switch (movement) {
      ...
      case FAST_FORWARD: position.add(Vec3.multiply(front, FAST_KEYBOARD_SPEED)); break;
      case FAST_BACK: position.add(Vec3.multiply(front, -FAST_KEYBOARD_SPEED)); break;
      case FAST_LEFT: position.add(Vec3.multiply(right, -FAST_KEYBOARD_SPEED)); break;
      case FAST_RIGHT: position.add(Vec3.multiply(right, FAST_KEYBOARD_SPEED)); break;
      case FAST_UP: position.add(Vec3.multiply(up, FAST_KEYBOARD_SPEED)); break;
      case FAST_DOWN: position.add(Vec3.multiply(up, -FAST_KEYBOARD_SPEED)); break;
    }
  }
