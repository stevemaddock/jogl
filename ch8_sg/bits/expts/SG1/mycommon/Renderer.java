...
public class Renderer {
  ...
  // do vertex shader variables first
  ...
  // then do fragment shader variables
  // Messy, as have to know what shader is expecting, e.g. light(s), material(s)
  // where material(s) can be BasicMaterial or TextureMaterial
  ...
  // rename shader textures in GLSL shader as diffuse_texture, specular_texture and emission_texture
  ...
  public void render(GL3 gl, Mesh mesh, Mat4 modelMatrix,  Shader shader, 
    ...
    // if use multiple lights, then need some tests here
    doSingleLight(gl, shader, light);

    // if use two types of material, BasicMaterial and TextureMaterial, then need to test for each
    // using instanceof
