...
public class M01e_GLEventListener implements GLEventListener {
  
  private static final boolean DISPLAY_SHADERS = false;
    
  public M01e_GLEventListener(Camera camera) {
    this.camera = camera;
  ...
  private Model tt1, cube, sphere2, sphere;
  private Light light;
  ...
  public void initialise(GL3 gl) {
    ...
    float sphereHeight = 3f;

    name = "sphere";
    mesh = new Mesh(gl, Sphere.vertices.clone(), Sphere.indices.clone());
    shader = new Shader(gl, "assets/shaders/vs_standard.txt", "assets/shaders/fs_standard_2t.txt");
    material = new Material(new Vec3(1.0f, 0.5f, 0.31f), new Vec3(1.0f, 0.5f, 0.31f), new Vec3(0.5f, 0.5f, 0.5f), 32.0f);
    modelMatrix = Mat4Transform.translate(0,cubeHeight,0);
    ...
    material = new Material(new Vec3(1.0f, 0.5f, 0.31f), new Vec3(1.0f, 0.5f, 0.31f), new Vec3(0.5f, 0.5f, 0.5f), 32.0f);
    modelMatrix = Mat4Transform.translate(0,cubeHeight+sphereHeight,0);
    modelMatrix = Mat4.multiply(modelMatrix,Mat4Transform.scale(1,sphere2Height,1));
    modelMatrix = Mat4.multiply(modelMatrix, Mat4Transform.translate(0,0.5f,0));
    sphere2 = new Model(name, mesh, modelMatrix, shader, material, light, camera);
  }
